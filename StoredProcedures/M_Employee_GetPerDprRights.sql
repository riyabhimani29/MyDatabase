...
/****** Object:  StoredProcedure [dbo].[M_Employee_GetPerDprRights]    Script Date: 26-04-2026 18:37:46 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[M_Employee_GetPerDprRights]          
     @Emp_Id int = 1,
        @Project_Id int = 1  
...
OUTER APPLY (
    ...
    WHERE  
        dbo.M_DPR_Rigths.Project_Id = @Project_Id
        AND
